...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kuri_mbzirc_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aravind/bayesian_challenge/install/${idir}'.  Ask the maintainer 'Tarek Taha <tarek@tarektaha.com>' to fix it.")
    endif()
