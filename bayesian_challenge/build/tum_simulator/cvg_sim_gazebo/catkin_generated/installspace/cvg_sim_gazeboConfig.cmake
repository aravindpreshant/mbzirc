...
if("FALSE" STREQUAL "TRUE")
  set(cvg_sim_gazebo_SOURCE_PREFIX /home/aravind/bayesian_challenge/src/tum_simulator/cvg_sim_gazebo)
  set(cvg_sim_gazebo_DEVEL_PREFIX /home/aravind/bayesian_challenge/devel)
  ...
  set(cvg_sim_gazebo_INSTALL_PREFIX /home/aravind/bayesian_challenge/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cvg_sim_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aravind/bayesian_challenge/install/${idir}'.  Ask the maintainer 'elliot <elliot@todo.todo>' to fix it.")
    endif()
